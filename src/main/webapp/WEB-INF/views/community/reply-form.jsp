...
<script>
    ...
    document.querySelector("#addReply").addEventListener("click", function () {
        ...
        if (urlPath.includes('board')){
          document.querySelector("input[name=type]").value = 'board';
        } else if (urlPath.includes('crew')) {
          document.querySelector("input[name=type]").value = 'crew';
      }
